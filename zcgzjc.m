...
U0=4.57155;r=48.9692;m=3.94064;p=2.21062;e1=3.42376;%162HZCBDI
...
noise2=sqrt(2*0.05)*rasd(length(t),1.6,0,1,0);
%x1=noise+x2';
  x1=x2'+noise2;
y1=hilbert(x1);
yIn=abs(y1);
...
[psd3, ~] = pwelch(xxxa, [], [], [], fs);
[psd, ~] = pwelch(x1, [], [], [], fs);
% RZV_values1 = RZV(xa);RZV_values2 = RZV(xxa);RZV_values3 = RZV(xxxa);ZIS_values = RZV(x1)/10000
% PMV_values1 = PMV(xa);PMV_values2 = PMV(xxa);PMV_values3 = PMV(xxxa);IMAS_values = PMV(x1)
% kurtosis_values1 = kurtosis(psd1);kurtosis_values2 = kurtosis(psd2);kurtosis_values3 = kurtosis(psd3);SKs_values = kurtosis(psd)*10
...
RZV_values1 = RZV(xa);RZV_values2 = RZV(xxa);RZV_values3 = RZV(xxxa);ZIS_values = RZV(x1)/100
PMV_values1 = PMV(xa);PMV_values2 = PMV(xxa);PMV_values3 = PMV(xxxa);IMAS_values = PMV(x1)*6
kurtosis_values1 = kurtosis(psd1);kurtosis_values2 = kurtosis(psd2);kurtosis_values3 = kurtosis(psd3);SKs_values = kurtosis(psd)
CBDI=log(SKs_values)./(IMAS_values.*exp(ZIS_values/2))
%% 频谱
% y0=fft(x1,10000); 
...
subplot(2,2,1);plot(ff,po02,'k');xlim([0 3000]);
xlabel('f/Hz');ylabel('Amplitude');

subplot(2,2,2);plot(ff,po1,'k');xlim([0 3000]);
xlabel('f/Hz');ylabel('Amplitude');
subplot(2,2,3);plot(ff,po01,'k');xlim([0 3000]);
xlabel('f/Hz');ylabel('Amplitude');
...
% subplot(2,2,1);plot(t,x1,'k');xlim([0 0.3])
% % title('时域');
% xlabel('t/s');ylabel('Amplitude');
% subplot(2,2,2);plot(t,y1,'k');xlim([0 0.3]);ylim([-200 200])
% xlabel('t/s');ylabel('Amplitude');
...
% xlabel('t/s');ylabel('Amplitude');
% 
% subplot(2,1,2);plot(ff,po02,'k');xlim([0 3000]);
% xlabel('f/Hz');ylabel('Amplitude');
% % subplot(3,1,3)
